...
import org.opensearch.lucene.store.PanamaNativeAccess;

import static org.opensearch.lucene.store.bufferpoolfs.StaticConfigs.DIRECT_IO_ALIGNMENT;
...
public class DirectIOReaderUtil {
     ...
     */
    public static MemorySegment directIOReadAligned(AsyncFile channel, long offset, long length, Arena arena) throws IOException {
        ...
        int bytesRead = 0;
        try {
            bytesRead = channel.read(directBuffer, alignedOffset).get();
