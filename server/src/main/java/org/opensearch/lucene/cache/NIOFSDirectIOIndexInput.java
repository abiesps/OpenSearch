...
public class NIOFSDirectIOIndexInput  extends BufferedIndexInput {
    ...
    public NIOFSDirectIOIndexInput(String resourceDesc, FileChannel fc, IOContext context)
        throws IOException {
    ...
    public NIOFSDirectIOIndexInput(
    ...
    @Override
    public NIOFSDirectIOIndexInput clone() {
        NIOFSDirectIOIndexInput clone = (NIOFSDirectIOIndexInput) super.clone();
        clone.isClone = true;
        return clone;
    }
    ...
    public IndexInput slice(String sliceDescription, long offset, long length) throws IOException {
        ...
        return new NIOFSDirectIOIndexInput(
